...
class App(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.keyword_listbox = tk.Listbox(left_frame, width=40, height=10)
        self.keyword_listbox.pack(fill=tk.BOTH, expand=True)

        # Create a frame to hold the search button
        button_frame = ttk.Frame(left_frame, style="default.TFrame")
        button_frame.pack(fill=tk.X, pady=(10, 0))

        # Create a button to start the search
        self.search_button = ttk.Button(button_frame, text="Search", command=self.search_keywords, style="default.TButton")
        ...
        self.rank_text = tk.Text(right_frame, wrap=tk.WORD, width=10, height=20)
        self.rank_text.pack(side=tk.LEFT, fill=tk.BOTH, expand=True)

        self.page_text = tk.Text(right_frame, wrap=tk.WORD, width=10, height=20)
